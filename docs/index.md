...
- Cada repte ha de deixar una part funcional i provable del producte.
...
- Hi pot haver contrastos o checkpoints compartits quan toque.
...
- [Guies de suport del Repte 3](04_materials/repte_03/index.md).
...
5. Consulta les [guies de suport del Repte 1](04_materials/repte_01/index.md).
...
- Deixar evidències reals i verificables del treball.
- Tindre `README`, proves, decisions i documentació al dia.
- Provar el que presentes.
- Explicar què has fet, per què i com ho has verificat.
- Poder defensar individualment el teu resultat.
